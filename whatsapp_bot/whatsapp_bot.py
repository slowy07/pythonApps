    ...
    def Driver():
        ...
        if type(no_of_message) == int:
            ...
            try:
                ...
                m1 = tk.Label(app_window,text="ERROR : Please enter digits for No of Messages.", fg="red", bg="black")

                canvas1.create_window(250, 170, window=m1)
                m1.after(5000, m1.destroy)

        if len(message_text) == 0 or len(str(no_of_message)) == 0:
            m1 = tk.Label(app_window,text="ERROR : Please fill the blanks.", fg="red", bg="black")
        ...
        if len(str(phone_number)) != 11:
            m1 = tk.Label(app_window,text="ERROR : Please enter 12 digits for Phone Number.", fg="red", bg="black")
...
def orangeSelection(event=None):
    ...
    def Add():
        ...
        if int(birth_month) > 12 or int(birth_month) <= 0:
            m1 = tk.Label(app_window,text="ERROR : Please enter in interval 1-12", fg="red", bg="black")
        ...
        if int(birth_day) > 30 or int(birth_day) <= 0:
            if len(birth_day) != 2:
                m1 = tk.Label(app_window,text="ERROR : Please enter 2 Digits", fg="red", bg="black")

                canvas1.create_window(250, 80, window=m1)
                m1.after(5000, m1.destroy)
            m1 = tk.Label(app_window,text="ERROR : Please enter in interval 1-30", fg="red", bg="black")
        ...
        if type(birth_month) == int and type(birth_day) == int:
            ...
            try:
                ...
                m1 = tk.Label(app_window,text="ERROR : Please enter digits for Birth Date.", fg="red", bg="black")
...
def greenSelection(event=None):
    ...
    def Driver():
        ...
        if len(message_text) == 0 or len(str(phone_number)) == 0 or len(str(hour)) == 0 or len(str(minutes)) == 0:
            ...
            m1.after(5000, m1.destroy)
        if hour >= 24:
            m1 = tk.Label(app_window,text ="ERROR : Please use 'Celebrate Birthday' Option (Hour>=24).", fg="red", bg="black")
...
ch4 = tk.Label(app_window, text="Send Message at Specific Time", fg="white", bg="lightgreen")
